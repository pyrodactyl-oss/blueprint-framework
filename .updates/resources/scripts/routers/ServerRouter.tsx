// RETURN: Blueprint fix was done roughly and may need further testing / work.
'use client';
                ...
                <>
                    ...
                    <div className='flex flex-row w-full lg:pt-0 pt-16'>
                        ...
                        <MainSidebar className='hidden lg:flex lg:relative lg:shrink-0 w-[300px] bg-[#1a1a1a]'>
                            ...
                            <ul data-pyro-subnav-routes-wrapper='' className='pyro-subnav-routes-wrapper'>
                                {/* Blueprint: before-subnav hook */}
                                <BeforeSubNavigation />
                                {/* Blueprint: additional navigation links */}
                                <NavigationLinks />
                    ...
                    {/* <Can action={['modrinth.*', 'modrinth.download']} matchAny>
                        ...
                        >
                            ...
                            {/* Blueprint: extra items and after-subnav hook */}
                                ...
                                {inConflictState &&
                                    ...
                                    <ErrorBoundary>
                                        <Routes location={location}>
                                            {/* Blueprint: mount its router so BP pages work */}
                                            <Route
                                                path="*"
                                                element={
                                                    <Suspense fallback={null}><NavigationRouter /></Suspense>
                                                }
                                            />
